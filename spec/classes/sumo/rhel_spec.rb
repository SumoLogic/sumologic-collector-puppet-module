...
describe 'sumo' do
  let(:facts) { { osfamily: 'Redhat', architecture: 'x86_64', sources_file_exists: true, sync_file_exists: true, service_file_exists: false } }
  ...
  context 'with sources_override false and local_config_mgmt false and source file does not exist' do
    let(:facts) { { osfamily: 'Redhat', architecture: 'x86_64', sources_file_exists: false, sync_file_exists: false, service_file_exists: false } }
  ...
  context 'with service already exists true' do
    let(:facts) { { osfamily: 'Redhat', architecture: 'x86_64', sources_file_exists: true, sync_file_exists: false, service_file_exists: true } }
    let(:params) { { accessid: 'accessid', accesskey: 'accesskey', local_config_mgmt: false, sources_override: false } }
  ...
  context 'with sync sources_override true and local_config_mgmt true and service already exists' do
    let(:facts) { { osfamily: 'Redhat', architecture: 'x86_64', sources_file_exists: false, sync_file_exists: false, service_file_exists: true } }
    let(:params) { { accessid: 'accessid', accesskey: 'accesskey', local_config_mgmt: true, sync_sources_override: true } }
